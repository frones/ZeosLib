...
begin
  ...
  try
    ...
    CheckStringFieldType(Query.Fields[2]{$IFNDEF NO_AUTOENCODE}.DataType{$ENDIF}, Connection.ControlsCodePage);
    ...
    CheckMemoFieldType(Query.Fields[6]{$IFNDEF NO_AUTOENCODE}.DataType{$ENDIF}, Connection.ControlsCodePage);
    {$IFDEF WITH_FTBYTE}
