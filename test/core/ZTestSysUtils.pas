...
begin
  ...
  CheckEquals(1012.75, SqlStrToFloatDef({$IFDEF PWIDECHAR_IS_PUNICODECHAR}PWideChar{$ELSE}UnicodeString{$ENDIF}('А 1.012,75'), 11.11));
  CheckEquals(11.11, SqlStrToFloatDef({$IFDEF PWIDECHAR_IS_PUNICODECHAR}PWideChar{$ELSE}UnicodeString{$ENDIF}('$1.0012,75'), 11.11));
  CheckEquals(11.11, SqlStrToFloatDef({$IFDEF PWIDECHAR_IS_PUNICODECHAR}PWideChar{$ELSE}UnicodeString{$ENDIF}('А 1.0012,75'), 11.11));
  ...
  CheckEquals(1012012.75, SqlStrToFloatDef({$IFDEF PWIDECHAR_IS_PUNICODECHAR}PWideChar{$ELSE}UnicodeString{$ENDIF}('А  1.012.012,75'), 11.11));
  ...
  CheckEquals(1012012111.75, SqlStrToFloatDef({$IFDEF PWIDECHAR_IS_PUNICODECHAR}PWideChar{$ELSE}UnicodeString{$ENDIF}('А  1.012.012.111,75'), 11.11));
  ...
  CheckEquals(11.11, SqlStrToFloatDef({$IFDEF PWIDECHAR_IS_PUNICODECHAR}PWideChar{$ELSE}UnicodeString{$ENDIF}('А  1.012.012.1119,75'), 11.11));
  ...
  CheckEquals(11.11, SqlStrToFloatDef({$IFDEF PWIDECHAR_IS_PUNICODECHAR}PWideChar{$ELSE}UnicodeString{$ENDIF}('А  1.012.0121.111,75'), 11.11));
  CheckEquals(-1012.75, SqlStrToFloatDef({$IFDEF PWIDECHAR_IS_PUNICODECHAR}PWideChar{$ELSE}UnicodeString{$ENDIF}('А -1.012,75'), 11.11));
  CheckEquals(-1012012111.75, SqlStrToFloatDef({$IFDEF PWIDECHAR_IS_PUNICODECHAR}PWideChar{$ELSE}UnicodeString{$ENDIF}('$-1.012.012.111,75'), 11.11));
  CheckEquals(1012012111.75, SqlStrToFloatDef({$IFDEF PWIDECHAR_IS_PUNICODECHAR}PWideChar{$ELSE}UnicodeString{$ENDIF}('$+1.012.012.111,75'), 11.11));
  CheckEquals(643.11, SqlStrToFloatDef({$IFDEF PWIDECHAR_IS_PUNICODECHAR}PWideChar{$ELSE}UnicodeString{$ENDIF}('А643,11'), 11.11));
  CheckEquals(643.11, SqlStrToFloatDef({$IFDEF PWIDECHAR_IS_PUNICODECHAR}PWideChar{$ELSE}UnicodeString{$ENDIF}('643,11 А'), 11.11));
...
const
  cS1 = UnicodeString('Mьller, Maier, Dцdelц');
  cS2 = UnicodeString('Muhende Mдддh''s');
var
  Between1, Between2: Cardinal;
  Start, Stop: Cardinal;
  S1, S2: UnicodeString;
