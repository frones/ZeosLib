...
{     Written by Sergey Seroukhov, Sergey Merkuriev       }
{                                                         }
{*********************************************************}
...
uses TestFramework, ZDbcIntfs, ZDbcConnection, SysUtils, ZCompatibility;
...
initialization
  TestFramework.RegisterTest(TZTestDbcUtilsCase.Suite);
end.
