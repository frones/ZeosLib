...
begin
  ...
  try
    ...
    begin
      ...
      begin
        s:={$IFDEF DELPHI12_UP}AnsiStrings.{$ENDIF}DupeString(utf8encode('123456ÈÈ‡‡'),6000);
        CheckEquals(StrLen(PAnsiChar(utf8encode('123456ÈÈ‡‡')))*6000, StrLen(PAnsiChar(s)), 'Length of DupeString Text');
      end
      else
      begin
        s:={$IFDEF DELPHI12_UP}AnsiStrings.{$ENDIF}DupeString('123456ÈÈ‡‡',6000);
        CheckEquals(StrLen(PAnsiChar('123456ÈÈ‡‡'))*6000, StrLen(PAnsiChar(s)), 'Length of DupeString Text');
      end;
