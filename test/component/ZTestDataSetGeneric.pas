  ...
  try
    ...
    begin
      ...
      begin
        ...
        CheckEquals(StrLen(PAnsiChar(utf8encode('123456ÈÈ‡‡')))*6000, I, 'Length of DupeString Text');
      end
      else
      begin
        s:={$IFDEF DELPHI12_UP}AnsiStrings.{$ENDIF}DupeString('123456ÈÈ‡‡',6000);
        I := StrLen(PAnsiChar(s));
        CheckEquals(StrLen(PAnsiChar('123456ÈÈ‡‡'))*6000, I, 'Length of DupeString Text');
      end;
