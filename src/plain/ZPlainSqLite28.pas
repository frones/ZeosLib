...
{ ************** Plain API Function types definition ************* }
  ...
  Tsqlite_open = function(const filename: PAnsiChar; mode: Integer;
    var errmsg: PAnsiChar): Psqlite; cdecl;
  ...
  Tsqlite_compile = function(db: Psqlite; const zSql: PAnsiChar;
    var pzTail: PAnsiChar; var ppVm: Psqlite_vm;
    var pzErrmsg: PAnsiChar): Integer; cdecl;
  Tsqlite_step = function(pVm: Psqlite_vm; var pN: Integer;
    var pazValue: PPAnsiChar; var pazColName: PPAnsiChar): Integer; cdecl;
