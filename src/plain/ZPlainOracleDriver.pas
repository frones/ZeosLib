...
begin
  ...
  AddCodePage('ZHS16GBK', 45); {GBK 16-bit Simplified Chinese UDC}
  ...
  AddCodePage('WE8EBCDIC37', 68); {EBCDIC Code Page 37 8-bit West European}
  AddCodePage('D8EBCDIC273', 69); {EBCDIC Code Page 273/1 8-bit Austrian German}
  AddCodePage('DK8EBCDIC277', 70); {EBCDIC Code Page 277/1 8-bit Danish}
  AddCodePage('S8EBCDIC278', 71); {EBCDIC Code Page 278/1 8-bit Swedish}
  AddCodePage('I8EBCDIC280', 72); {EBCDIC Code Page 280/1 8-bit Italian}
  AddCodePage('WE8EBCDIC284', 73); {EBCDIC Code Page 284 8-bit Latin American/Spanish}
  ...
  AddCodePage('EE8MSWIN1250', 160); {MS Windows Code Page 1250 8-bit East European}
  AddCodePage('CL8MSWIN1251', 161); {MS Windows Code Page 1251 8-bit Latin/Cyrillic}
  AddCodePage('WE8MSWIN1252', 162); {MS Windows Code Page 1252 8-bit West European}
  AddCodePage('EL8MSWIN1253', 163); {MS Windows Code Page 1253 8-bit Latin/Greek}
  AddCodePage('BLT8MSWIN1257', 164); {MS Windows Code Page 1257 8-bit Baltic}
  AddCodePage('BLT8CP921', 165); {Latvian Standard LVS8-92(1) Windows/Unix 8-bit Baltic}
  AddCodePage('LV8PC8LR', 166); {Latvian Version IBM-PC Code Page 866 8-bit Latin/Cyrillic}
  ...
  AddCodePage('CL8KOI8R', 170); {RELCOM Internet Standard 8-bit Latin/Cyrillic}
  ...
  AddCodePage('TR8EBCDIC1026', 196); {EBCDIC Code Page 1026 8-bit Turkish}
  ...
  AddCodePage('UTF8', 226, ceUTF8); {Unicode 3.0 UTF-8 Universal character set, CESU-8 compliant}
  AddCodePage('UTFE', 227, ceUTF8); {EBCDIC form of Unicode 3.0 UTF-8 Universal character set}
end;
{$ENDIF}
