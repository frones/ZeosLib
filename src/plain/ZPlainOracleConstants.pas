...
(*--------------------------- OCIObjectPin ----------------------------------*)
  ...
  TOCIObjectPin = function(env: POCIEnv; err: POCIError;  object_ref: POCIRef;
                       corhdl: POCIComplexObject; pin_option: OCIPinOpt;
                       pin_duration: OCIDuration;
                       lock_option: OCILockOpt; _object: PPointer): sword; cdecl;
(*
...
(*--------------------------- OCIObjectGetObjectRef -------------------------*)
  TOCIObjectGetObjectRef = function(env: POCIEnv; err: POCIError; _object: Pointer;
                                out object_ref: POCIRef): sword; cdecl;
(*
