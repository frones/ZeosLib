...
const ParamType2OleIO: array[TZParamType] of DBTYPEENUM = (
  DBPARAMIO_INPUT, DBPARAMIO_INPUT, DBPARAMIO_OUTPUT,
  DBPARAMIO_INPUT or DBPARAMIO_OUTPUT, DBPARAMIO_OUTPUT);
