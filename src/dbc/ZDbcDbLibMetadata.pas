...
begin
  ...
  with GetStatement.ExecuteQuery('exec master.sp_columns '+
...
begin
    ...
    with GetStatement.ExecuteQuery('exec master.sp_column_privileges '+
...
begin
  ...
  with GetStatement.ExecuteQuery('exec master.' +
