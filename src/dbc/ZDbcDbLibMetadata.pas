...
begin
  ...
  with GetStatement.ExecuteQuery('exec master.sys.sp_columns '+
...
begin
    ...
    with GetStatement.ExecuteQuery('exec master.sys.sp_column_privileges '+
...
begin
  ...
  with GetStatement.ExecuteQuery('exec master.sys.' +
