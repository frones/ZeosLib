...
type
  ...
  protected
    ...
    function PrepareAnsiSQLQuery: ZAnsiString; override;
    function PrepareAnsiSQLParam(ParamIndex: Integer;
      const NChar: Boolean): ZAnsiString; reintroduce;
...
function TZDBLibPreparedStatementEmulated.PrepareAnsiSQLQuery: ZAnsiString;
var
  I: Integer;
  ParamIndex: Integer;
  Tokens: TStrings;
...
function TZDBLibPreparedStatementEmulated.PrepareAnsiSQLParam(ParamIndex: Integer;
  const NChar: Boolean): ZAnsiString;
begin
