...
begin
  ...
  FPlainDriver.OCIAttrSet(FSessionHandle, OCI_HTYPE_SESSION, PAnsiChar(AnsiString(User)),
    Length(User), OCI_ATTR_USERNAME, FErrorHandle);
  FPlainDriver.OCIAttrSet(FSessionHandle, OCI_HTYPE_SESSION, PAnsiChar(AnsiString(Password)),
